<div class="container-fluid">
        <div class="row justify-content-evenly">
            ...
            <div class="col-12 col-lg-3">
                ...
                style="max-width: 390px; width: 100%; z-index: 4; padding-top: 57px;">
                   <div class="shadow p-3 me-5 bg-main">
                    <ul class="navbar-nav mt-1 ms-1 d-flex flex-column pb-5 mb-2"
                    style="padding-top: 1px">
                        ...
                        <li class="btn-bg dropdown-item p-1 mt-3 rounded" id="myButton">
                            <div class="d-flex">
                             ...
                             <a href="index.html" class="d-flex ms-3
                             align-items-center
                         ...
                         <li class="btn-bg dropdown-item p-1 mt-3 rounded" id="myButton">
                             ...
                             <a href="friend.html" class="d-flex ms-3
                             align-items-center
                             text-decoration-none text-dark">
                         ...
                         <li class="btn-bg dropdown-item p-1 mt-3 rounded" id="myButton">
                             <div class="d-flex">
                             <i class="fa-solid fa-user-group bg-gay p-2 rounded-circle" style="font-size: 20px; color: #000;"></i>
                             <a href="all-friend.html" class="d-flex ms-3
                             align-items-center
                             text-decoration-none text-dark">
            ...
            <div class="col-12 col-lg-9">
                ...
                style="padding-top: 57px; max-width: 1000px"
                >
                ...
                <div class="pb-3 mt-3 align-content-center justify-content-between">
                    <div class="row align-items-center">
                        <div class="col-3">
                            <img src="./img/av2.jpg" alt="" class="img" style="width: 100%;">
                            <div class="shadow fb-1" style="padding-top: 1px;">
                ...
                <div
                class="d-flex flex-column justify-content-center w-100 mx-auto"
                style="padding-top: 15px; max-width: 1000px"
                >
                <div class="mt-2 d-flex justify-content-between position-relative">
                    <div class="timeline d-flex pb-3 justify-content-between align-content-center">
                         ...
                         <p class="m-0 text-blue">Xem tất cả</p>
                    </div>
                </div>
                <div class="pb-3 mt-3 align-content-center justify-content-between">
                    <div class="row align-items-center">
                        <div class="col-3">
                            ...
                            <div class="shadow fb-1" style="padding-top: 1px;">
                                <p class="m-0 mt-2 ms-2" style="font-size: 16px; font-weight: 600;">Kiệt Nhỏ</p>
                                <div class="d-grid gap-2 mx-auto mt-2">
                                    <input type="button" class="btn btn-greenest" value="Thêm bạn bè" style="width: 90%; margin-left: 11px; font-weight: 500;">                    
                                    <input type="button" class="btn btn-delete" value="Xoá,gỡ" style="width: 90%; margin-left: 11px; font-weight: 500;"> 
                                </div>                         
                            </div>
                        </div>
                        <div class="col-3">
