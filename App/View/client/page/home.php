                    ...
                    <div class="bg-white rounded shadow-sm mt-3">
                      ...
                      <div class="post__comment position-relative pt-0">
                        ...
                        <div class="comment-modal flex-column position-relative w-100 h-100" style="max-height: 600px;">
                          ...
                          <div class="comment-list mt-3 p-3 h-100 overflow-y-auto srollbar" style="height: 400px;max-height: 500px; padding-bottom: 115px !important; order: 2;">
                          </div>
                          <div class="position-absolute bottom-0 bg-white w-100 px-3" style="z-index: 10; height: 110px; box-shadow: 0px -6px 4px -6px rgba(0, 0, 0, 0.2); order: 3;">
