                ...
                <ul class="navber-nav mt-4 ms-3 d-flex flex-column pb-5 mb-5" style="padding-top: 56px;">
                    ...
                    <li class="dropdown-item p-1 rounded">
                        <a href="" class="text-decoration-none text-dark d-flex align-items-center">
                            <div class="p-2">
                                <img src="./images/avatar.png" alt="avata" class="rounded-circle me-2" style="width: 38px; height: 38px; object-fit: cover;">
                            </div>
                            <div class="">
                    ...
                    <li class="dropdown-item p-1 rounded">
                        <a href="" class="text-decoration-none text-dark d-flex align-items-center">
                            <div class="p-2">
                                <!-- <i data-visualcompletion="css-img" class="" style="background-image:url('https://static.xx.fbcdn.net/rsrc.php/v3/yz/r/4GR4KRf3hN2.png');background-position:0 -407px;background-size:auto;width:36px;height:36px;background-repeat:no-repeat;display:inline-block"></i> -->
                ...
                <div class="content">
                  ...
                  <div class="stories">
                    <a href="./upload_story.html" class="story">
                      <img src="./images/avatar.png" alt="" class="position-relative">
        ...
        <div class="col-12 col-lg-3">
          ...
          >
            <div class="p-3 mt-4">
              ...
              >
                <p class="text-muted fs-5 m-0">Lời mời kết bạn</p>
                <!-- icons -->
                  ...
                  data-bs-content='
                          <div>
                            <div class="popover-body d-flex p-2">
                              <div>
                                <img src="./images/avatar.png" alt="avatar" class="pop-avatar"  />
                              </div>
                              <div >
                                <h5>Hồ Dư Mai Trân</h5>
                                <div class="d-flex">
                                  <i class="fas fa-user-friends m-1 text-muted"></i>
                                  <p>2 mutual friends: <span class="fw-bold">Minh Triết</span> and <span class="fw-bold">Khánh Duy</span></p>
                                </div>
                                <div class="d-flex">
                              ...
                              <div>
                                <div class="popover-body d-flex p-2">
                                  ...
                                  <div >
                                    ...
                                    <div class="d-flex">
                                      <i class="fas fa-user-friends m-1 text-muted"></i>
                                      <p>2 mutual friends: <span class="fw-bold">Hồ Dư Mai Trân</span> and <span class="fw-bold">Lê Như</span></p>
                                    </div>
                                    <div class="d-flex">
                                    <i class="fas fa-graduation-cap m-1 text-muted"></i>
                                    <p>Studies at MIT</p>
