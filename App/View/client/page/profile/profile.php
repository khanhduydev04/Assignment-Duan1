<main>
  <div class="pt-5 bg-white w-100 d-flex justify-content-center shadow-sm">
    <div class="profile d-flex flex-column align-items-center">
      <div class="profile-cover d-flex justify-content-center position-relative">
        <img src="banner-2.png" alt="" id="image-cover" class="w-100 rounded-3">
        <!-- Nút mở modal -->
      ...
      <div class="main-container d-flex align-items-center position-relative border-bottom px-3 pb-3">
        <div class="profile-avatar position-relative me-4" style="width: 170px; height: 170px; margin-top: -70px;">
          <img src="avt.png" alt="" id="avatar" class="rounded-circle w-100">
          <!-- Nút mở modal -->
            ...
            <div class="modal-content">
              <form action="" method="post">
                ...
                <div class="modal-body">
                  ...
                  <div class="preview col-12 mb-3 mx-auto ">
                    <img src="" alt="image-preview" class="w-50 rounded-circle" id="imagePreview" style="aspect-ratio: 1/1;">
                  </div>
                </div>
                <div class="modal-footer" style="display: none;">
      ...
      <div class="main-container w-100%">
        <ul class="m-0 py-2 d-flex align-items-center gap-1 list-unstyled" style="height: 60px;">
          <li class="nav__btn nav__btn-active"><a href="#" class="btn px-4 py-2 text-decoration-none fw-medium">Bài
              viết</a></li>
          <li class="nav__btn"><a href="#" class="btn px-4 py-2 text-decoration-none fw-medium">Bạn
              bè</a></li>
      ...
      <div class="d-none d-lg-flex flex-column gap-3" style="max-width: 426px;">
        <div class="profile-photos bg-white rounded-3 p-3 shadow-sm">
          <div class="pb-3 d-flex justify-content-between align-items-center">
            <h5><a href="#" class="fs-4 fw-bold text-dark text-decoration-none">Ảnh</a></h5>
            <a href="#" class="text-decoration-none">Xem tất cả ảnh</a>
          </div>
          <div class="rounded-3 overflow-hidden d-flex flex-wrap" style="gap: 4px;">
            <img src="banner-2.png" alt="" class="profile-img">
            <img src="banner-2.png" alt="" class="profile-img">
            <img src="banner-2.png" alt="" class="profile-img">
            <img src="banner-2.png" alt="" class="profile-img">
            <img src="banner-2.png" alt="" class="profile-img">
        ...
        <div class="profile-friends bg-white rounded-3 p-3 shadow-sm">
          <div class="pb-3 d-flex justify-content-between align-items-center">
            <h5><a href="#" class="fs-4 fw-bold text-dark text-decoration-none">Bạn bè</a></h5>
            <a href="#" class="text-decoration-none">Xem tất cả bạn bè</a>
          </div>
          <div class="d-flex flex-wrap" style="column-gap: 8px;">
            <div class="friend-item mb-2">
              <a href="#">
                <img src="./banner-2.png" alt="" class="friend-image w-100 object-fit-cover rounded-2">
              </a>
